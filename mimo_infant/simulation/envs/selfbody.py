...
The class with the environment is :class:`~mimo_infant.simulation.envs.selfbody.MIMoSelfBodyEnv` while the path to the scene XML is
...
from mimo_infant.simulation.envs.mimo_env import MIMoEnv, DEFAULT_PROPRIOCEPTION_PARAMS, SCENE_DIRECTORY
...
class MIMoSelfBodyEnv(MIMoEnv):
    ...
    def __init__(self,
        ...
        mimo_utils.set_joint_qpos(self.model,
                                 self.data,
                                 "mimo_location",
        ...
        for joint_name in SITTING_POSITION:
            mimo_utils.lock_joint(self.model, joint_name, joint_angle=SITTING_POSITION[joint_name][0])
