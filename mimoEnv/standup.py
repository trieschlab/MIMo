...
Trained models are saved automatically into the `models` directory and prefixed with `standup`, i.e. if you name your
model `my_model`, it will be saved as `models/standup_my_model`.
