...
from mimo_infant.growth.utils import growth_function, calc_volume
import argparse
import json
import re
import os
...
DIR_MIMO = "mimo_infant/simulation/assets/mimo/"
...
def update_defaults() -> None:
    ...
    within the `mimo_infant/simulation/assets/mimo/` directory.
    """
