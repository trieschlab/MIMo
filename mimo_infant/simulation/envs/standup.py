...
The class with the environment is :class:`~mimo_infant.simulation.envs.standup.MIMoStandupEnv` while the path to the scene XML is
...
from mimo_infant.simulation.envs.mimo_env import MIMoEnv, SCENE_DIRECTORY, DEFAULT_PROPRIOCEPTION_PARAMS, DEFAULT_VESTIBULAR_PARAMS
...
class MIMoStandupEnv(MIMoEnv):
    ...
    Even though we define a success condition in :meth:`~mimo_infant.simulation.envs.standup.MIMoStandupEnv._is_success`, it is
