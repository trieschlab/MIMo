...
The interface is defined as an abstract class in :class:`~mimo_infant.vestibular.vestibular.Vestibular`.
...
from mimo_infant.simulation.utils import get_sensor_addr
