...
The interface is defined as an abstract class in :class:`~mimo_infant.actuation.actuation.ActuationModel`.
The spring-damper model is defined in :class:`~mimo_infant.actuation.actuation.TorqueMotorModel`.
A second implementation using direct positional control is :class:`~mimo_infant.actuation.actuation.PositionalModel`.
"""
import numpy
import numpy as np
