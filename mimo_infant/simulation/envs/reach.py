...
The class with the environment is :class:`~mimo_infant.simulation.envs.reach.MIMoReachEnv` while the path to the scene XML is defined
in :data:`REACH_XML`.
"""
import os
import numpy as np
...
class MIMoReachEnv(MIMoEnv):
    ...
    :meth:`~mimo_infant.simulation.envs.reach.MIMoReachEnv.sample_goal` and
    :meth:`~mimo_infant.simulation.envs.reach.MIMoReachEnv.get_achieved_goal` are dummy functions.
    """
    def __init__(self,
