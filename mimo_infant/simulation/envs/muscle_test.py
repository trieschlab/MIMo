...
isometric torque, :class:`~mimo_infant.simulation.envs.muscle_test.MIMoStaticMuscleTestEnv` and
:class:`~mimo_infant.simulation.envs.muscle_test.MIMoStaticMuscleTestV2Env`, and unlocked scenes where MIMo is floating but can move
his joints, :class:`~mimo_infant.simulation.envs.muscle_test.MIMoVelocityMuscleTestEnv` and
:class:`~mimo_infant.simulation.envs.muscle_test.MIMoVelocityMuscleTestV2Env`, to determine stable VMAX parameters.
...
from mimo_infant.simulation.envs.mimo_env import SCENE_DIRECTORY, MIMoEnv
from mimo_infant.simulation.envs.dummy import MIMoDummyEnv
...
class MIMoComplianceEnv(MIMoDummyEnv):
    ...
    def __init__(self,
        ...
        for joint_name in joint_names:
            mimo_utils.lock_joint(self.model, joint_name)
        mimo_utils.unlock_joint(self.model, "robot:right_shoulder_ad_ab")
        mimo_utils.lock_joint(self.model, "robot:right_hand1", joint_angle=-0.25)
