...
The interface is defined as an abstract class in :class:`~mimo_infant.proprioception.proprio.Proprioception`.
A simple implementation directly reading values is in :class:`~mimo_infant.proprioception.proprio.SimpleProprioception`.

"""

import numpy as np
from typing import Dict, List
from mimo_infant.simulation.utils import get_joint_qpos_addr, get_joint_qvel_addr, get_sensor_addr
...
class SimpleProprioception(Proprioception):
    ...
    The following attributes are provided in addition to those of :class:`~mimo_infant.proprioception.proprio.Proprioception`.
