...
Trained models are saved automatically into the "models/reach" directory, i.e. if you name your model "my_model", it
will be saved as "models/reach/my_model".
...
def main():
    ...
    - ``--save_model``: The name under which we save.
    """
    ...
    while train_for > 0:
        ...
        model.save("models/reach/" + save_model + "/model_" + str(counter))
