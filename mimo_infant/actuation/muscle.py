...
from mimo_infant.actuation.actuation import ActuationModel
...
class MuscleModel(ActuationModel):
    ...
    this is :func:`~mimo_infant.actuation.muscle_testing.calibrate_full`.
