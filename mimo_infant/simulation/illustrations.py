    ...
    for idx in range(test_for):
        ...
        if done or trunc or (idx==test_for-1):
            ...
            if render_video:
                ...
                video_path=os.path.join(save_dir, f"episode_{im_counter}.avi")
                ...
                images = []
                im_counter += 1
                print(f"Saved episode {im_counter-1} video to {video_path}")
...
def main():
    ...
    parser.add_argument('--algorithm', default=None, required=False,
