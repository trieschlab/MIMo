...
from mimoEnv.envs.mimo_env import MIMoEnv, SCENE_DIRECTORY, DEFAULT_VESTIBULAR_PARAMS, \
    DEFAULT_PROPRIOCEPTION_PARAMS, DEFAULT_TOUCH_PARAMS_V2
from mimoTouch.touch import TrimeshTouch
import mimoEnv.utils as env_utils

BENCHMARK_XML = os.path.join(SCENE_DIRECTORY, "benchmark_multicam_scene.xml")
...
DEFAULT_VISION_PARAMS = {
    "eye_left_center": {"width": 128, "height": 128},
    "eye_right_center": {"width": 128, "height": 128},
    "eye_left_mid": {"width": 128, "height": 128},
    "eye_right_mid": {"width": 128, "height": 128},
    "eye_left_far": {"width": 128, "height": 128},
    "eye_right_far": {"width": 128, "height": 128},
    "eye_left_periph": {"width": 128, "height": 128},
    "eye_right_periph": {"width": 128, "height": 128},
}

# Basic version: ~4.27 pixels per degree
# Multicam:     25.6 pixels per degree at center (5)
#               6.4 pixels per degree at mid (20)
#               ~2.13 pixels per degree at far (60)
#               1.28 pixels per degree at peripheral (100)


class MIMoMultiCamEnv(MIMoEnv):
    ...
    #    self.vision.save_obs_to_file("multicam", suffix=str(self.steps))
    #    self.steps += 1
    #    return obs
